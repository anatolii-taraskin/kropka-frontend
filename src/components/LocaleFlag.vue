...
const normalizedCode = computed(() => (props.code ?? '').toString().toLowerCase());
...
const svgClasses = computed(() => {
  ...
  return `w-12 h-12 ${attrClass}`.trim();
});
</script>

<template>
  <svg
    v-if="normalizedCode === 'ru'"
    :class="svgClasses"
    viewBox="0 0 512 512"
